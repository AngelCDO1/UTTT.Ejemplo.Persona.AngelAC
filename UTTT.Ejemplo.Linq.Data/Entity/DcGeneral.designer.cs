...
namespace UTTT.Ejemplo.Linq.Data.Entity
{
    ...
    partial void OncorreoElecChanging(string value);
    partial void OncorreoElecChanged();
    partial void OnrfcChanging(string value);
    partial void OnrfcChanged();
    partial void OnCodigoPosChanging(string value);
    partial void OnCodigoPosChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_correoElec", DbType="VarChar(50)")]
		public string correoElec
		{
			...
			set
			{
				if ((this._correoElec != value))
				{
					this.OncorreoElecChanging(value);
					this.SendPropertyChanging();
					this._correoElec = value;
					this.SendPropertyChanged("correoElec");
					this.OncorreoElecChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CodigoPos", DbType="VarChar(50)")]
		public string CodigoPos
		{
			get
			{
				return this._CodigoPos;
			}
			set
			{
				if ((this._CodigoPos != value))
				{
					this.OnCodigoPosChanging(value);
					this.SendPropertyChanging();
					this._CodigoPos = value;
					this.SendPropertyChanged("CodigoPos");
					this.OnCodigoPosChanged();
				}
			}
		}
