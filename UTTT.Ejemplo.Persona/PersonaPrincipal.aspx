...
<body>
        ...
        <div>
             ...
             <asp:GridView ID="dgvPersonas" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="intNumHermanos" HeaderText="Num. Hermanos" 
    ...
    <asp:LinqDataSource ID="DataSourcePersona" runat="server" 
        ...
        Select="new (strNombre, strAPaterno, strAMaterno, CatSexo, dteFechaNacimiento, intNumHermanos,correoElec, rfc, CodigoPos, strClaveUnica,id)" 
